...
class PocketBall{
	...
	// : 정적 내부 클래스에서는 사용 불가
	static class PoketMonster{
		static String name = "꼬부기";
		// 정적 내부 클래스 내의 인스턴스 변수 - 해당 정적 클래스를 인스턴스화 한 이후
		int level = 20;
...
public class C_StaticClass {
	...
	public static void main(String[] args) {
		...
		PocketBall.PoketMonster poketmon = new PocketBall.PoketMonster();
	...
	System.out.println(PocketBall.PoketMonster.name);
