...
class Text{
	...
	static {System.out.println("Static { } "); } // 클래스 초기화 블럭
	// 게임 스타트 라던지 처음 한번 실행되는 걸 static으로 하면 좋을듯?
	...
	void method() {
		// 지역 변수 -> 사용할려면 반드시 초기화가 이루어져야함
		int i;  // 선언 가능( 사용하기 전)
//		int j = i; // i 변수를 사용하기 전에 초기화 하지 않아 오류 - Error
