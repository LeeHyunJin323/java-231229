...
class Dog2 extends Animal2{
	...
	@Override // 현재 메서드가 부모 클래스의 메서드를 오버라이딩을 한다는 것을 명시
	void sound() { 
		System.out.println("개가 멍멍하고 짖습니다."); // 클래스의 메서드 이름과 매개변수의 개수가 같으면 부모 클래스의 메서드가 생략
	}
}
...
class Cat2 extends Animal2{
	@Override // 현재 메서드가 부모 클래스의 메서드를 오버라이딩을 한다는 것을 명시
	void sound() { 
		System.out.println("고양이가 야옹하고 짖습니다."); // 클래스의 메서드 이름과 매개변수의 개수가 같으면 부모 클래스의 메서드가 생략
	}
}
public class Overriding {
	...
	public static void main(String[] args) {
		...
		// 2. 오버라이딩
		// - 상속관계에 있는 클래스에서 사용
		// - 메서드의 시그니처(이름 , 매개변수 , 반환타입)이 같아야 한다.
