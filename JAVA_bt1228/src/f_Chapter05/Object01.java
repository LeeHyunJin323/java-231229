...
//! 인스턴스 변수
// : 클래스의 각 객체(인스턴스)에 속한 변수 ,각 객체 마다 독립적인 값을 가짐
...
class Dog{
	...
	Dog(String name,int age){
		...
		//객체의 인스턴스 변수 = "choco"; this가 이거랑 같음
		this.name = name;
		this.age = age;
		// 위에 만들 Dog클래스의 객체의 age에 age값을 할당함
...
class Student{
	//클래스 변수의 경우 변수 서언 맨 처음에 static 키워드로 정의
	// : 모든 객체에 같은 값
