...
final class MyFinalClass{
	...
	// : 변수명을 모두 대문자로 작성 , 단어와 단어의 연결(_)
	final int FIANL_VALUABLE = 30; 
//	FIANL_VALUABLE = 10; - Error  -> 재할당하면 오류남
...
// - , _ 기호의 차이점
	// choco-cake  - 는 cake 누르면 cake만 드래그됨
	// choco_cake _를 사용하면 더블 클릭하면 코드 한번에 드래그됨
