...
// >> 자바에서는 java.io 패키지에서 주로 입출력과정을 담당

//! Stream
// : 데이터가 순차적으로 흐르는 통로를 의미
// : 자바 프로그래밍이 디스크에 접근하여 데이터를 주고 받는 작업을 도와주는 통로
// - 스트림을 통해 데이터는 소스로부터 목적지까지 일련의 연속된 흐름으로 이동
//    : 단방향 통신 (입력 스트림과 출력 스트림을 별도로 사용)
//    : FIFO 구조 (First in First Out, 선입선출) - 큐
...
// - 스트림의 예외 처리
// : try-catch 블록을 사용하여 예오 발생 처리를 권장
