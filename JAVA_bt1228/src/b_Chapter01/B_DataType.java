...
//		2-1. 정수 타입 (8바투 == 1바이트)
//		byte: 8바이트 정수 - 값의 범위 : -128 ~ 127 
//		short : 16바이트 정수 - 값의 범위 : -32,768 ~ 32767
//		int (가본): 32바이트 정수 - 값의 범우 : 약 -2.1억 ~ 약 2.1억)
//		long : 8바이트 정수 - 값의 범위(약 -2의63제곱 ~ 약 -2의63제곱)
...
//		- 종류
//		  1. String : 문자열을 저장하는 데 사용하는 참조 자료형
//		  2. Array : 배열을 나타내는 참조 자료형
