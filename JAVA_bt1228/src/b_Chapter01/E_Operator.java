...
// 자바의 연산자
// : 산술 연산자 , 대입연산자 , 비교 연산자, 논리 연산자, 삼항 연산자
...
//		: 상수에는 증감 연산자 사용 X
		final int NUMBER = 10;
//		NUMBER++; 상수는 변하면 안되는 수니깐 오류 -Error
		
		
//		증가 연산자 (++)
//		연산자의 조항 혹은 우항의 값을 1 증가 시킴
		int integer = 10;
...
//		+= : 좌항에 우항을 더한 값을 좌항에 대입
		num += 3; // num = num + 3; 10+3 이니깐 13
		
//		-= : 좌항에 우항을 뺀 값을 좌항에 대입
		
		num -= 6; // num = num - 6; 13 - 6 이니깐 7임 
...
//		&& (앰퍼센트) : and 연산자
//		:좌항과 우항이 모두 true 일때 true , 하나라도 false인 경우 false
		int andOper1 = 8;
		int andOper2 = 3;
...
//		||(vertical bar) : Or 연산자
//		:좌항과 우항 중 하나라도 true이면 true , 모두 false 인 경우 false
		int orOper1 = 5;
		int orOper2 = 7;
