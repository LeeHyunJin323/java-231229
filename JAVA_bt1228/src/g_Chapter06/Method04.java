...
class Operator{
	...
	int add() {return a+b;} //a , b 는 인스턴스 변수
	int subtract() {return a-b;} //a , b 는 인스턴스 변수
	int multiply() {return a*b;} //a , b 는 인스턴스 변수
	double divide() {return a/b;} //a , b 는 인스턴스 변수
