...
public class ClassPractice {
	...
	public static void main(String[] args) {
		// 정적(클래스) 변수
		// - 클래스이름.클래스변수로 직접 사 용이 가능
		// 객체 생성 없이 사용 가능
		System.out.println("Card Width :" + Card.width +"Card Height : " + Card.height);
		
		// 클래스 Card의 객체(인스턴스) 생성
		Card c1 = new Card(); // 클래스 Card타입의 c1 변수 선언
		...
		//Card.width 처럼 클래스 이름으로 불러오는게 좋음 
		// 객체 생성하여 static을 접근하는 것은 별로 권장X 
