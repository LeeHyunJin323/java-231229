...
public class D_Interface03 {
	...
	public static void main(String[] args) {
		ExampleInterface exClass = new ExampleClass();
		exClass.printVar();
		exClass.method();
		
		
		ExampleInterface exampleInterface = exClass;
		exampleInterface.printVar();
